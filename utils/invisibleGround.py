...
def invisibleGround(location = (0,0,0), groundSize = 5, shadowDarkeness = 0.18):
	...
	tree.links.new(tree.nodes["Principled BSDF"].outputs['BSDF'], tree.nodes['Mix Shader'].inputs[2])
	...
	tree.nodes["Principled BSDF"].inputs['Base Color'].default_value = (1,1,1,1)
